                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="input_status_sekolah" name="buku">
                            @foreach (App\Models\Buku::all() as $bukus)
    ...
    const table = {
            ...
            render(resultJson) {
                ...
                resultJson.forEach(row => {
                    ...
                    htmlRow.find('.td-tanggal-kembali').text(row.tanggal_pengembalian? row.tanggal_pengembalian : "Belum Dikembalikan");
                    htmlRow.find('.td-status').text(row.status);
